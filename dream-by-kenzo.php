  ...
  <section class="guadeloupe_web_page">
    <div class="container_video_100vh">
      <div class="video_container">
        ...
        <iframe class="video_kenzo" src="https://www.youtube.com/embed/mAo0UBh1jPQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; playsinline; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
      </div>
      <h2><span>Dream By Kenzo </span>- Enzo Cosson</h2>
    </div>

    <div class="description">
      <p>
        <span class="titre">Description :</span><br /><br />Cette vidéo est un
        projet universitaire consistant à créé un spot publicitaire fictif
        pour la marque Kenzo intitulé "Dream". Avec une musique captivante,
        nous avons réussi à créer une ambiance onirique qui vous transportera
        dans un monde imaginaire.
      </p>

      <p>
        <span class="titre">Crédits :</span><br /><br />
        Réalisateur : <span>Enzo COSSON / Benjamin FRENAL</span> <br />
        Cadreur : <span>Enzo COSSON</span><br />
        Monteur : <span>Enzo COSSON</span><br />
        Modélisation 3D : <span>Enzo COSSON</span><br />
        Acteur : <span>Benjamin FRENAL</span> <br />
        Concepteur du flacon : <span>Thibault LIVRAN</span> <br />
        Lumière : <span>Adrien GUILLEMOT</span>
      </p>

      <p>
        <span class="titre">Musique : </span><a href="https://www.youtube.com/watch?v=UdTzq4pnB6o&t=0s">Where you are - Halal beats</a>
      </p>
    </div>

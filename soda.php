...
<head>
  ...
  <link rel="canonical" href="https://www.enzo-cosson.fr/soda/" />
  <title>Portfolio | Site - Soda</title>
  <meta name="description" content="Je suis fier de vous présenter mon dernier projet de site web, dédié à une marque de soda fictive.">
...
<body>
  ...
  <main>
    <section class="presentation_site">
      <h1 class="bg_title">SODA</h1>
      <img class="imac" src="/img/mockup/imac_soda.webp" alt="imac sur le site soda" />
      <a class="bdd_redirection_top" href="https://mmi21e03.mmi-troyes.fr/soda/" target="_blank">Y accéder</a>
    </section>

    <div class="more_info">
      <h1>SITE PORTFOLIO</h1>
      <div class="green_rect"></div>
      <img src="/img/mockup/ipad_soda.webp" alt="ipad sur le site soda" class="mockup_ipad_soda" />
      <div class="description_soda">
        <h2 class="more_info_titre">POURQUOI CE SITE ?</h2>
        <p class="description_paragraphe">
          J'ai réalisé ce site dans mes débuts, je commencais à vouloir voir
          plus loin, un site avec plus de design et d'animation et la
          découverte du parallax. Ce site est inspiré d'un concept sur
          Dribbble.
        </p>
      </div>
    ...
    <div class="bdd">
      <div class="container_illu">
        ...
        <video class="imovix_catalogue" autoplay muted loop>
          <source src="/mp4/demo_soda.mp4" type="video/mp4" />
        </video>
    ...
    <div class="bdd_more">
      <p class="bdd_text">
        "Site réalisé à partir d'un concept Dribbble. Reproduire des concepts
        ou des sites que j'aime et la clée de mon évolution.”
      </p>
      <a class="bdd_redirection" href="https://mmi21e03.mmi-troyes.fr/soda/">Y accéder</a>
    </div>
...
<script src="/js/scrollMagicSoda.js"></script>

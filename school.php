...
<body>
  ...
  <main>
    ...
    <div class="more_info">
      ...
      <div class="description_school">
        ...
        <p class="description_paragraphe">
          Dans mon école, en MMI ( métier du multimédier et de l'internet ),
          chaque étudiant doit avoir son propre site de travail sur lequel il
          doit mettre en ligne ses projets pour être évalué.
        </p>
      </div>
    ...
    <div class="bdd_more">
      <p class="bdd_text">
        "J'ai souhaité me donner à fond pour réaliser un beau et bon site de
        travail pour mes cours car c'est celui que j'utilise et que je vais
        utiliser pendant mes 3 ans de formation à l'iut, alors je n'ai pas
        voulu le négliger”
      </p>
      <a class="bdd_redirection" href="https://mmi21e03.mmi-troyes.fr" target="_blank">Y accéder</a>
    </div>

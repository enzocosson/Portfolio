...
<head>
  ...
  <link rel="canonical" href="https://www.enzo-cosson.fr/book/" />
...
<body>
  ...
  <main>
    ...
    <div class="more_info">
      ...
      <img src="./img/mockup/iphone_book2.webp" alt="iphone sur le site book" class="mockup_iphone_book" />
      <div class="description_book">
        <h2 class="more_info_titre">POURQUOI CE SITE ?</h2>
        <p class="description_paragraphe">
          Pour réaliser ce site portfolio je me suis inspiré d'une maquette
          réalisé par un designer sur dribble afin de me donner le défi de la
          reproduire. J'ai réalisé ce site en utilisant les technologies HTML,
          CSS et Javascript.
        </p>
      </div>
      <img src="./img/moon.png" alt="moon" class="moon_illu" />
    ...
    <div class="bdd">
      <div class="container_illu">
        ...
        <video class="imovix_catalogue" autoplay muted loop>
          <source src="./mp4/demo_book.mp4" type="video/mp4" />
        </video>
    ...
    <div class="bdd_more">
      <p class="bdd_text">
        "En tant que développeur front-end, je peux créer des sites Web qui
        sont à la fois attrayants et fonctionnels. La satisfaction de voir le
        produit final et de voir comment il fonctionne et comment les gens
        interagissent avec lui est très gratifiant. De plus, de nombreuses
        technologies front-end évoluent constamment et sont en constante
        évolution, ce qui permet aux développeurs front-end de rester à la
        pointe des technologies actuelles et de créer des expériences Web
        innovantes.”
      </p>
      <a class="bdd_redirection" href="https://mmi21e03.mmi-troyes.fr/book/" target="_blank">Y accéder</a>
    </div>
...
<script src="./js/scrollMagicBook.js"></script>

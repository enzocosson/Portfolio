...
<body>
  ...
  <section class="container_cards_admin">
    ...
    <div class="confirmation" style="display: none;">
      <div class="pupUp">
        ...
        <div class="interaction">
          ...
          <a href="admin_mountain_fullimage_suppr.php?id=<?php echo $id; ?>" class="oui">Oui</a>
        </div>
      </div>
    </div>
    <?php
    ...
    <a class="ajouter_une_photo" href="./ajout/admin_mountain_fullimage_ajout.php">Ajouter une photo</a>

  ...
  <section class="container_formulaire">
    ...
    <div class="information_photo">
      ...
      if (isset($_GET['id'])) {
        ...
        $req = "SELECT * FROM night_paysage WHERE photo_id = $id";
        ...
        if ($resultat->rowCount() == 1) {
          ...
          echo '<form id="form_modif" method="post" onsubmit="return confirmerModification()" action="by_night_paysage_modif_traitement.php" >';
          ...
          echo '<a class="retour" href="./admin_by_night_paysage.php">Retour</a>';
      ...
      <div class="container_photo">
        <img src="../img/photo/by_night/paysage/<?php echo $filename; ?>" alt="<?php echo $alt; ?>" />
      </div>

  ...
  <section class="container_formulaire">
    ...
    <div class="information_photo">
      ...
      if (isset($_GET['id'])) {
        ...
        $req = "SELECT * FROM gold_paysage WHERE photo_id = $id";
        ...
        if ($resultat->rowCount() == 1) {
          ...
          echo '<form id="form_modif" method="post" onsubmit="return confirmerModification()" action="gold_paysage_modif_traitement.php" >';
          ...
          echo '<a class="retour" href="./admin_gold_paysage.php">Retour</a>';
      ...
      <div class="container_photo">
        <img src="../img/photo/gold/paysage/<?php echo $filename; ?>" alt="<?php echo $alt; ?>" />
      </div>

  ...
  <section class="container_formulaire">
    ...
    <div class="information_photo">
      ...
      if (isset($_GET['id'])) {
        ...
        $req = "SELECT * FROM tropical_portrait WHERE photo_id = $id";
        ...
        if ($resultat->rowCount() == 1) {
          ...
          echo '<form id="form_modif" method="post" onsubmit="return confirmerModification()" action="tropical_portrait_modif_traitement.php" >';
          ...
          echo '<a class="retour" href="./admin_tropical_portrait.php">Retour</a>';
      ...
      <div class="container_photo">
        <img src="../img/photo/tropical/portrait/<?php echo $filename; ?>" alt="<?php echo $alt; ?>" />
      </div>

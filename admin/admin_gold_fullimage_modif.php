  ...
  <section class="container_formulaire">
    ...
    <div class="information_photo">
      ...
      if (isset($_GET['id'])) {
        ...
        $req = "SELECT * FROM gold_fullimage WHERE photo_id = $id";
        ...
        if ($resultat->rowCount() == 1) {
          ...
          echo '<form id="form_modif" method="post" onsubmit="return confirmerModification()" action="gold_fullimage_modif_traitement.php" >';
          ...
          echo '<a class="retour" href="./admin_gold_fullimage.php">Retour</a>';
      ...
      <div class="container_photo">
        <img src="../img/photo/gold/fullimage/<?php echo $filename; ?>" alt="<?php echo $alt; ?>" />
      </div>

  ...
  <section class="container_formulaire">
    ...
    <div class="information_photo">
      ...
      if (isset($_GET['id'])) {
        ...
        $req = "SELECT * FROM tropical_paysage WHERE photo_id = $id";
        ...
        if ($resultat->rowCount() == 1) {
          ...
          echo '<form id="form_modif" method="post" onsubmit="return confirmerModification()" action="tropical_paysage_modif_traitement.php" >';
          ...
          echo '<a class="retour" href="./admin_tropical_paysage.php">Retour</a>';

...
<body>
    ...
    <section class="container_formulaire">
        ...
        <form action="./admin_tropical_paysage_ajout_traitement.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="interaction">
                <a class="retour" href="../admin_tropical_paysage.php">Retour</a>

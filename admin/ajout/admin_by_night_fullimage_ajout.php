...
<body>
    ...
    <section class="container_formulaire">
        ...
        <form action="./admin_by_night_fullimage_ajout_traitement.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="interaction">
                <a class="retour" href="../admin_by_night_fullimage.php">Retour</a>

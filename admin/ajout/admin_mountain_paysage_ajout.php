...
<body>
    ...
    <section class="container_formulaire">
        ...
        <form action="./admin_mountain_paysage_ajout_traitement.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="interaction">
                <a class="retour" href="../admin_mountain_paysage.php">Retour</a>

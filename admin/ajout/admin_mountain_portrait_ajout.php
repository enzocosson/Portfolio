...
<body>
    ...
    <section class="container_formulaire">
        ...
        <form action="./admin_mountain_portrait_ajout_traitement.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="interaction">
                <a class="retour" href="../admin_mountain_portrait.php">Retour</a>

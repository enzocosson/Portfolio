...
<body>
    ...
    <section class="container_formulaire">
        ...
        <form action="./admin_tropical_fullimage_ajout_traitement.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="interaction">
                <a class="retour" href="../admin_fullimage_portrait.php">Retour</a>

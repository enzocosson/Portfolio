export function scrollMagicSoda() {
  const pathImac = {
    curviness: 1.25,
  ...
  const more = new TimelineMax()
    ...
    .add(
      TweenMax.to(".mockup_ipad_soda", 2, {
        bezier: pathSoda,
        ease: Power1.easeInOut,
      }),
      "-=1"
    ...
    .add(
      TweenMax.to(".canette_illu", 1, {
        bezier: pathCanetteIllu,
        ease: Power1.easeInOut,
      }),
      "-=2.5"
    )

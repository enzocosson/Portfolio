  ...
  var t = 180 / Math.PI,
    ...
    h = function (t, s, n, a, o) {
      ...
      for (h = 0; w > h; h++)
        (c = t[b]),
          ...
          o
            ? ((y = e[h]),
              (T = i[h]),
              (x = (0.25 * (T + y) * s) / (a ? 0.5 : r[h] || 0.5)),
              (p = _ - (_ - u) * (a ? 0.5 * s : 0 !== y ? x / y : 0)),
              (d = _ + (f - _) * (a ? 0.5 * s : 0 !== T ? x / T : 0)),
              (m = _ - (p + (((d - p) * ((3 * y) / (y + T) + 0.5)) / 4 || 0))))
            : ((p = _ - 0.5 * (_ - u) * s),
              (d = _ + 0.5 * (f - _) * s),
              (m = _ - (p + d) / 2)),
          (p += m),
      ...
      (c = t[b]),
        ...
        (c.ba = P - c.a),
        n &&
          ((v = l(c.a, P, c.c, c.d)), t.splice(b, 1, v[0], v[1], v[2], v[3]));
    },
    u = function (t, r, s, n) {
      var o,
        l,
      ...
      if (n)
        for (t = [n].concat(t), l = t.length; --l > -1; )
          "string" == typeof (f = t[l][r]) &&
            "=" === f.charAt(1) &&
            (t[l][r] = n[r] + Number(f.charAt(0) + f.substr(2)));
      if (((o = t.length - 2), 0 > o))
        return (c[0] = new a(t[0][r], 0, 0, t[-1 > o ? 0 : 1][r])), c;
      for (l = 0; o > l; l++)
        (h = t[l][r]),
          (u = t[l + 1][r]),
          (c[l] = new a(h, 0, 0, u)),
    ...
    _ = function (t, n, a, l, _, f) {
      var c,
        ...
        w = [],
        b = f || t[0];
      (_ = "string" == typeof _ ? "," + _ + "," : o), null == n && (n = 1);
      for (p in t[0]) w.push(p);
      if (t.length > 1) {
        for (T = t[t.length - 1], y = !0, c = w.length; --c > -1; )
          if (((p = w[c]), Math.abs(b[p] - T[p]) > 0.05)) {
            y = !1;
            break;
          }
        y &&
      ...
      for (e.length = i.length = r.length = 0, c = w.length; --c > -1; )
        (p = w[c]),
          (s[p] = -1 !== _.indexOf("," + p + ",")),
          (x[p] = u(t, p, s[p], f));
      for (c = e.length; --c > -1; )
      ...
      if (!l) {
        for (c = w.length; --c > -1; )
          if (s[p])
            for (d = x[w[c]], v = d.length - 1, m = 0; v > m; m++)
              (g = d[m + 1].da / i[m] + d[m].da / e[m]),
                (r[m] = (r[m] || 0) + g * g);
    ...
    f = function (t, e, i) {
      ...
      for (h = v.length; --h > -1; ) {
        for (f = v[h], d[f] = l = [], c = 0, _ = t.length, u = 0; _ > u; u++)
          (r =
            null == i
              ? t[u][f]
              ...
              : Number(p)),
            g && u > 1 && _ - 1 > u && (l[c++] = (r + l[c - 2]) / 2),
            (l[c++] = r);
        for (_ = c - m + 1, c = 0, u = 0; _ > u; u += m)
          (r = l[u]),
            (s = l[u + 1]),
            (n = l[u + 2]),
            (o = 2 === m ? 0 : l[u + 3]),
    ...
    c = function (t, e, i) {
      for (
        var r, s, n, a, o, l, h, u, _, f, c, p = 1 / i, d = t.length;
        --d > -1;
              ...
              (r = c[n][a]),
                (this._func[r] =
                  "function" == typeof t[r]
                    ...
                    : !1);
            (r = c[n][2]),
              (this._initialRotations[n] = this._func[r]
      ...
      set: function (e) {
        ...
        if (this._timeRes) {
          ...
          if (
            ...
            (e -= this._l1),
            (s = this._si),
            e > this._s2 && _.length - 1 > s)
          ) {
            for (h = _.length - 1; h > s && e >= (this._s2 = _[++s]); );
            (this._s1 = _[s - 1]), (this._si = s);
          } else if (this._s1 > e && s > 0) {
            for (; s > 0 && (this._s1 = _[--s]) >= e; );
          ...
          (i = 0 > e ? 0 : e >= 1 ? f - 1 : (f * e) >> 0),
            (o = (e - i * (1 / f)) * f);
        for (r = 1 - o, s = this._props.length; --s > -1; )
          (n = this._props[s]),
            (a = this._beziers[n][i]),
      ...
      if (t) {
        ...
        e._registerComplexSpecialProp("bezier", {
          parser: function (t, e, n, a, o, l) {
            ...
            if (0 > c) return o;
            for (h = 0; c >= h; h++)
              (_ = i(t, f[h], a, o, l, c !== h)), (p[h] = _.end);
            for (u in e) m[u] = e[u];
            return (
              (m.values = p),
              (o = new s(t, "bezier", 0, 0, _.pt, 2)),
              (o.data = _),
              (o.plugin = l),
              (o.setRatio = r),
              ...
              l._onInitTween(_.proxy, m, a._tween),
              o
            );
          },
        });

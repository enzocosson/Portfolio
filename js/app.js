...
switch (url) {
  ...
  case "https://www.enzo-cosson.fr/video.html":
    ...
    break;
                         ...
                         // -----------
  case "http://192.168.1.70:5500/guadeloupe.html":
    darkModeGalerie();
        cursorFollow();
    break;
  case "http://10.152.22.39:5500/guadeloupe.html":
    darkModeGalerie();
        cursorFollow();
    break;
  ...
  case "https://www.enzo-cosson.fr/guadeloupe.html":
    ...
    break;
                         ...
                         // -----------
  case "http://192.168.1.70:5500/auvergne.html":
    darkModeGalerie();
        cursorFollow();
    break;
  case "http://10.152.22.39:5500/auvergne.html":
    darkModeGalerie();
        cursorFollow();
    break;

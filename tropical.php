...
<body>
  ...
  <header class="header" id="rth">
    ...
    <ul class="menu">
      <li style="--i: 1">
        <a class="links barba-link" href="/accueil">Accueil</a>
      </li>
      <li style="--i: 2">
  ...
  <footer>
    <div class="info">
      <div class="reseaux">
        <h2>Suis moi sur mes réseaux</h2>
        <div class="logo_reseaux">
          <a href="https://www.linkedin.com/in/enzo-cosson/" target="_blank">
          ...
          <a href="https://github.com/enzocosson" target="_blank">
          ...
          <a href="https://dribbble.com/nzo_cos" target="_blank">
          ...
          <a href="https://www.facebook.com/enzo.cosson.5/" target="_blank">
          ...
          <a href="https://www.instagram.com/nzo_cos/" target="_blank">
